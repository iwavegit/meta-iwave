...
compile_mx8() {
    ...
    cp ${S}/../../../../../../../sources/meta-iwave/recipes-bsp/imx-mkimage/imx-boot/mx8qm-iwg27m-scfw-tcm_4gb.bin ${BOOT_STAGING}/scfw_tcm.bin
    elif [ "${MACHINE}" = "imx8qm-iwg27m-8gb" ]; then
    cp ${S}/../../../../../../../sources/meta-iwave/recipes-bsp/imx-mkimage/imx-boot/mx8qm-iwg27m-scfw-tcm_8gb.bin ${BOOT_STAGING}/scfw_tcm.bin
    fi
